...
connection directly between two browsers, no server involved at all,
distinct from and unrelated to the still-unbuilt PowerSync/API sync
boundary above. It does move real data now: docs/24's merge (categories/
